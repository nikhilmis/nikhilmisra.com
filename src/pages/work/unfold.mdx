...
<Img src={import('/images/unfold/typeface.svg')} alt={'A diverse future for all of us.'} />
<Text
...
<Carousel
    ...
    images={[
        { src: import('/images/unfold/unfoldwebsite1.png'), alt: 'Unfold website' },
        { src: import('/images/unfold/unfoldwebsite2.png'), alt: 'Unfold website in Chinese' },
    ]}
/>
<Text
...
<Carousel
    ...
    images={[
        { src: import('/images/unfold/unfoldarchivesplash.png'), alt: 'Unfold splash screen' },
        { src: import('/images/unfold/unfoldarchive.png'), alt: 'Unfold sign-up page' },
    ]}
/>
